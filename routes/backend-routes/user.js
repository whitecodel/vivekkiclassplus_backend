                    ...
                    if (!phone) {
                        try {
                            ...
                            const plan = Plan({
                                ...
                                months: item.Months,
                                amount: item.Amount,
                                videos: item.Videos == 'Yes' || item.Videos == 'yes' ? true : false,
                                notes: item.Notes == 'Yes' || item.Notes == 'yes' ? true : false,
                                sociology_videos: item['Sociology Videos'] == 'Yes' || item['Sociology Videos'] == 'yes' ? true : false,
                                sociology_notes: item['Sociology Notes'] == 'Yes' || item['Sociology Notes'] == 'yes' ? true : false,
                            });
                            await plan.save();
                        } catch (error) {
                            // console.log(error);
...
const formatData = (data) => {
    return new Promise(async (resolve, reject) => {
        for (var i in data) {
            try {
                data[i].expiry_date = moment(parseInt(data[i].active_date)).add(data[i].months, 'M').format('DD MMM YYYY');
                ...
                data[i].last_update_time = moment(parseInt(user.last_update_time)).format('DD MMM YYYY');
            } catch (error) {
                console.log(error);
            }
        }
