...
router.post(
  "/sociology-video-categories/addnewvideocategory",
  NotLoggedIn,
  async (req, res) => {
    try {
...
router.post(
  "/sociology-video-categories/editvideocategory",
  NotLoggedIn,
  async (req, res) => {
    try {
...
router.post(
  "/sociology-video-categories/deletevideocategory",
  NotLoggedIn,
  async (req, res) => {
    try {
      ...
      if (sociologyvideocategory.subcategory) {
        const sociologyvideosubcategories =
          await SociologyVideosubcategory.find({
