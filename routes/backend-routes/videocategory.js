...
router.post('/video-categories/addnewvideocategory', NotLoggedIn, async (req, res) => {
    try {
...
router.post('/video-categories/editvideocategory', NotLoggedIn, async (req, res) => {
    try {
...
router.post('/video-categories/deletevideocategory', NotLoggedIn, async (req, res) => {
    try {
